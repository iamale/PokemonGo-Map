...
def token_request(args, status, url):
    ...
    try:
        captcha_id = s.post("http://2captcha.com/in.php?key={}&soft_key=1634&method=userrecaptcha&googlekey={}&pageurl={}".format(args.captcha_key, args.captcha_dsk, url)).text.split('|')[1]
